...
public class FizzBuzzSolutionTest {
    ...
    public void shouldReturnFizzBuzzOrNumber(){
        ...
        assertThat(classToTest.fizzBuzz(11), is("fizz fake deluxe"));
        assertThat(classToTest.fizzBuzz(22), is("deluxe"));
        assertThat(classToTest.fizzBuzz(111), is("fizz fake deluxe"));
        ...
        assertThat(classToTest.fizzBuzz(777), is("fizz fake deluxe"));
